...
const BookList = () => {
    ...
    useEffect(() => {
        axios.get('https://rocky-eyrie-45311.herokuapp.com/orderedByEmail?email=' + loggedInUser.email)
            .then(res => {
                setOrders(res.data);
            })
    ...
    const handleDeleteService = (id) => {
        ...
        swal({
            ...
            if (wantDelete) {
                ...
                axios.delete(`https://rocky-eyrie-45311.herokuapp.com/cancel-order/${id}`)
                    .then(res => {
